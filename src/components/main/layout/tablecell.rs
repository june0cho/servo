...
use layout::flow::{TableCellFlowClass, FlowClass, Flow, FlowData, ImmutableFlowUtils};
use layout::flow;
...
/// A table cell formatting context.
...
impl TableCellFlow {
    pub fn new(base: FlowData) -> TableCellFlow {
        TableCellFlow {
            base: base,
            box: None,
            float: None,
    ...
    pub fn from_box(base: FlowData, box: Box) -> TableCellFlow {
        TableCellFlow {
            base: base,
            box: Some(box),
            float: None,
    ...
    pub fn float_from_box(base: FlowData, float_type: FloatType, box: Box) -> TableCellFlow {
        TableCellFlow {
            base: base,
            box: Some(box),
    ...
    pub fn new_float(base: FlowData, float_type: FloatType) -> TableCellFlow {
        TableCellFlow {
            base: base,
            box: None,
            float: Some(~FloatedBlockInfo::new(float_type)),
